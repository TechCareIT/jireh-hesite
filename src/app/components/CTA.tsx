...
export default function CTA() {
  return (
    <section id="contact" className="grain relative overflow-hidden py-14 lg:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-5 lg:px-10">
        {/* Header */}
        <div className="mb-8 text-center lg:mb-10">
          ...
          <p className="mx-auto mt-4 max-w-md font-body text-[14px] text-text-muted lg:text-lg">
            Fill out the form below — or call/message me directly.
          </p>
        </div>

        {/* Form */}
        <div className="rounded-2xl border border-border bg-dark/50 p-6 backdrop-blur-sm sm:p-8">
          <ContactForm />
        </div>
        ...
        <div className="mt-6 flex flex-col items-center gap-3 sm:flex-row sm:justify-center sm:gap-4">
          <a
            ...
            className="btn-ghost flex w-full items-center justify-center gap-2 rounded-full px-6 py-3.5 text-sm sm:w-auto"
          >
        ...
        <p className="mt-4 text-center font-body text-[11px] text-text-dim">
